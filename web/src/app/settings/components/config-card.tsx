          ...
          <Col xs={24} lg={12}>
            ...
            {proxyTestResult ? (
              <Alert
                ...
                showIcon
                title={proxyTestResult.ok ? `代理可连接 chatgpt.com，用时 ${proxyTestResult.latency_ms} ms` : `代理无法完整连接 chatgpt.com：${proxyTestResult.error ?? "未知错误"}（用时 ${proxyTestResult.latency_ms} ms）`}
